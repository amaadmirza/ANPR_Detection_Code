...
def predict_speed(
    ...
    #This is where again you have to make it, because somehow parameter passing is not working here
    roi_position=200

    print("ROI IS in function: ",roi_position)

    #Slight change in the logic , for downward direction, change top to bottom, here
    # and on 69
    if len(bottom_position_of_detected_vehicle) != 0 and (roi_position-15) < top and top < (roi_position+15) :
